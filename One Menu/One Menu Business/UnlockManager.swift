...
class UnlockManager: NSObject, ObservableObject, SKPaymentTransactionObserver, SKProductsRequestDelegate {
    ...
    init(somestring: String) {
       ...
       // self.dataController = dataController
        ...
        let productIDs = Set(["com.featurex.OneMenuBusinness.unlock", "OneMenuBusiness_LaunchPrice_1m_1w0", "bla"])
    ...
    func productsRequest(_ request: SKProductsRequest, didReceive response: SKProductsResponse) {
        DispatchQueue.main.async {
            ...
            print("Loaded In-App Purchases: \(self.loadedProducts.count) Invalid ids: \(response.invalidProductIdentifiers)")
